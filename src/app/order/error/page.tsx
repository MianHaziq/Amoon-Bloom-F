  ...
  return (
    <Container className="flex min-h-[60vh] flex-col items-center justify-center py-24 text-center">
      ...
      <p className="mt-4 max-w-lg text-base text-ink-600">
        Something interrupted the checkout — your card was not charged and your
        cart is still saved. Please try again, or reach out and a member of our
        team will compose your order by hand.
      </p>
