...
export const SnapchatIcon = ({ size = 20, ...rest }: IconProps) => (
  <svg width={(size * 512) / 512} height={size} viewBox="0 0 512 512" fill="currentColor" aria-hidden="true" {...rest}>
    <path d="M496.926,366.6c-3.373-9.176-9.8-14.086-17.112-18.153-1.376-.806-2.641-1.451-3.72-1.947-2.182-1.128-4.4-2.22-6.615-3.4-22.9-12.143-40.786-27.512-53.16-45.8a102.883,102.883,0,0,1-9.028-16.9c-1.086-3.111-1.038-4.87-.264-6.457a10.451,10.451,0,0,1,2.919-3.126c3.912-2.58,7.94-5.184,10.652-6.936,4.859-3.135,8.717-5.616,11.2-7.372,9.34-6.522,15.9-13.452,20.1-21.222a42.418,42.418,0,0,0,2.089-35.126c-6.191-16.373-21.686-26.538-40.452-26.538a55.68,55.68,0,0,0-11.71,1.242c-1.019.216-2.032.443-3.035.7.171-11.067-.076-22.755-1.062-34.244-3.472-40.334-17.6-61.487-32.341-78.315a130.487,130.487,0,0,0-33.454-26.869C303.567,10.719,280.62,5,256,5s-47.483,5.719-68.394,17.05a130.516,130.516,0,0,0-33.454,26.869c-14.739,16.828-28.868,37.988-32.341,78.315-.987,11.489-1.233,23.178-1.062,34.244-1-.259-2.016-.486-3.035-.7a55.667,55.667,0,0,0-11.71-1.242c-18.766,0-34.261,10.165-40.452,26.538a42.415,42.415,0,0,0,2.089,35.126c4.2,7.77,10.762,14.7,20.1,21.222,2.485,1.756,6.343,4.237,11.2,7.372,2.6,1.679,6.44,4.158,10.208,6.65a10.909,10.909,0,0,1,3.363,3.412c.807,1.652.848,3.443-.331,6.686a102.844,102.844,0,0,1-8.911,16.6c-12.106,17.885-29.516,32.999-51.746,45.026-11.782,6.244-24.016,10.375-29.462,25.185-4.108,11.172-1.431,23.9,8.949,34.717a52.6,52.6,0,0,0,13.294,10.076,141.831,141.831,0,0,0,32.5,13.278,9.278,9.278,0,0,1,2.828,1.242c5.5,4.831,4.716,12.1,12.028,22.685a53.51,53.51,0,0,0,13.943,14.311c15.693,10.835,33.332,11.518,52.006,12.24,16.873.653,36,1.392,57.865,8.6,9.1,3.006,18.514,8.815,29.412,15.514,26.171,16.077,58.6,36.02,112.664,36.02s86.626-20.021,113-36.181c10.823-6.629,20.164-12.351,29-15.267,21.867-7.208,40.996-7.947,57.865-8.6,18.674-.722,36.309-1.405,52.006-12.24a53.489,53.489,0,0,0,15.6-17.379c5.209-8.966,5.008-15.219,10.166-19.735a8.869,8.869,0,0,1,2.7-1.2,141.982,141.982,0,0,0,32.955-13.437,52.324,52.324,0,0,0,14.036-11.1l.087-.1C498.408,389.926,500.752,377.657,496.926,366.6Z" />
  </svg>
);
...
export const YouTubeIcon = ({ size = 20, ...rest }: IconProps) => (
  <svg width={(size * 576) / 512} height={size} viewBox="0 0 576 512" fill="currentColor" aria-hidden="true" {...rest}>
...
/** "Translate" glyph (the standard language-switcher icon: a macron'd
 *  character beside a smaller "A") — filled, not stroke-based, to match the
 *  client's reference site exactly rather than our line-icon set. */
